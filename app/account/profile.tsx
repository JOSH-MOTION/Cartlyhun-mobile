      ...
      <SafeAreaView edges={['top']} className="bg-white border-b border-gray-50">
        <View className="px-6 py-4 flex-row items-center justify-between">
          <View className="flex-row items-center">
            ...
            <Text className="text-xl font-black text-gray-900 uppercase tracking-tighter ml-2">Edit Profile</Text>
          </View>
          <TouchableOpacity 
            onPress={handleSave} 
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 24 }}>
        ...
        <View className="items-center mb-10">
          <View className="relative">
            <View className="w-32 h-32 bg-gray-50 rounded-[44px] overflow-hidden border-4 border-primary/10 shadow-lg items-center justify-center">
            ...
            <TouchableOpacity className="absolute bottom-0 right-0 bg-primary p-3 rounded-2xl border-4 border-white shadow-md">
              <LucideCamera size={18} color="#fff" />
            </TouchableOpacity>
          </View>
          <View className="mt-4 flex-row items-center bg-green-50 px-4 py-1.5 rounded-full">
        ...
        <View className="gap-y-6">
          <View>
            <Text className="text-[10px] font-black text-gray-400 uppercase tracking-[3px] mb-3 ml-2">Full Name</Text>
            <View className="bg-gray-50 border border-gray-100 rounded-3xl px-6 py-4 flex-row items-center">
              ...
              <TextInput 
                className="flex-1 ml-4 text-gray-900 font-black uppercase text-xs"
                value={name}
          ...
          <View>
            <Text className="text-[10px] font-black text-gray-400 uppercase tracking-[3px] mb-3 ml-2">Email Address</Text>
            <View className="bg-gray-50 border border-gray-100 rounded-3xl px-6 py-4 flex-row items-center opacity-60">
              <LucideMail size={18} color="#94a3b8" />
              <Text className="flex-1 ml-4 text-gray-900 font-black uppercase text-xs">{user?.email}</Text>
              <LucideCheck size={16} color="#10b981" />
            </View>
            <Text className="text-[9px] text-gray-400 font-bold mt-2 ml-4 uppercase">Email cannot be changed from the mobile app.</Text>
          </View>
        </View>
